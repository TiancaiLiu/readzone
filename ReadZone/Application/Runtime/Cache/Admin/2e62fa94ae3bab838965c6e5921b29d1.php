        ...
        <ul class="sidebar-list">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="/ReadZone/index.php/Admin/Admin/show"><i class="icon-font">&#xe003;</i>管理员管理</a></li>
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    <a href="#"><i class="icon-font">&#xe003;</i>常用操作</a>
                    <ul class="sub-menu">
                        <li><a href="/ReadZone/index.php/Admin/Article/lst"><i class="icon-font">&#xe005;</i>文章管理</a></li>
                        <li><a href="/ReadZone/index.php/Admin/Cate/lst"><i class="icon-font">&#xe006;</i>分类管理</a></li>
                        <li><a href="/ReadZone/index.php/Admin/Link/lst"><i class="icon-font">&#xe052;</i>友情链接</a></li>
                        <li><a href="/ReadZone/index.php/Admin/Admin/lst"><i class="icon-font">&#xe008;</i>管理员管理</a></li>
                    </ul>
                </li>
    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/ReadZone/index.php/Admin/Admin/search" method="post">
            ...
            <form name="" id="" action="" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/ReadZone/index.php/Admin/Admin/add"><i class="icon-font"></i>新增管理员</a>
