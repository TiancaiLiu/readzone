...
<!-- <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/ReadZone/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">栏目管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/ReadZone/Admin/Cate/search" method="post">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/ReadZone/Admin/Cate/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/ReadZone/Admin/Cate/add"><i class="icon-font"></i>新增栏目</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                       ...
                       <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td title=""><a target="_blank" href="#" title=""><?php echo ($v["catename"]); ?></a>
                                </td>
                                <td width="10%">
                                    <a class="link-update" href="/ReadZone/Admin/Cate/edit/id/<?php echo ($v["id"]); ?>"><i class="icon-font">&#xe045;</i> 修改</a>
                                    <a class="link-del" onclick="return confirm('确定要删除该栏目吗？？？');" href="/ReadZone/Admin/Cate/del/id/<?php echo ($v["id"]); ?>"><i class="icon-font">&#xe037;</i> 删除</a>
                                </td>
