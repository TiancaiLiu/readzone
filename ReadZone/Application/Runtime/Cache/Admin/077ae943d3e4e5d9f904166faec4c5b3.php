...
<!-- <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/ReadZone/Admin/Index/">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">管理员管理</span></div>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td width="10%">
                                    <a class="link-update" href="/ReadZone/Admin/Admin/edit/id/<?php echo ($v["id"]); ?>">修改</a>
                                    <?php if($v['id'] != 1): ?><a class="link-del" onclick="return confirm('确定要删除该管理员？？？');" href="/ReadZone/Admin/Admin/del/id/<?php echo ($v["id"]); ?>">删除</a><?php endif; ?>
                                </td>
